...
- [View on Sepolia Etherscan](https://sepolia.etherscan.io/address/0x02C38b6383D03deb6257AEcCd6Cf2126048edA9F)
- [Verified source on Sourcify](https://repo.sourcify.dev/11155111/0x02C38b6383D03deb6257AEcCd6Cf2126048edA9F) (Exact Match — source code publicly verified against on-chain bytecode)
...
2. Paste `SecureToken.sol` into a new file
3. Compile with Solidity 0.8.20
4. Deploy via "Injected Provider - MetaMask" on Sepolia, passing an initial supply (e.g. `1000000`) to the constructor
